 ...
 * a [ðŸ“¸ Capture Area] manual capture button, and a prominent [âœ• Exit Crop] button.
 */
class CropOverlayView @JvmOverloads constructor(
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        // 7. Draw Explicit [âœ• Exit Crop] Pill Button at Top Right
        val exitW = dp(90f)
        val exitH = dp(28f)
